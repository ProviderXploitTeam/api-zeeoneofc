...
loghandler = {
    notparam: {
        ...
        getApikey: 'Call me with To get Apikey.. wa.me/6281804680327'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Call me with To get Apikey.. wa.me/6281804680327'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'SenApi') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'SenApi') return res.json(loghandler.invalidKey)
